function compartmentSegmentationInner(g,image_dir,boundary_dir,nuc_dir,out_dir)
...
%     tic
    ...
    nucSeg=imerode(nucSeg,strel('disk',1));
...
%     toc
        ...
        print(['Skipping compartment segmentation ' num2str(g)])
