...
def predict_holdout_e(test_index,txt_loc,lbl_loc,f,model_path,batch_size):
    ...
    with tf.Session() as sess:
        ...
        for step in range(0,len(holdout_f_vector)):
            ...
            val_loss,val_acc,c_p = sess.run([loss_op,MSE_,prediction], feed_dict={X: holdout_batch, Y: holdout_label, dropout1: 1, dropout2: 1})
